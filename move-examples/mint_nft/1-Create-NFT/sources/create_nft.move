...
/// base token.
/// An example is using this kind of NFT as event ticket: each NFT is a ticket and has properties like 
///expiration_sec:u64, and 
///is_ticket_used:bool.
...
module mint_nft::create_nft {
    ...
    // All the NFT has the same URI TokenName but with different version
