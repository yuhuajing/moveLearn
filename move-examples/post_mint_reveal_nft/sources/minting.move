...
module post_mint_reveal_nft::minting {
    ...
    struct NFTMintConfig has key {
        treasury: address, // minting fees consisting of blockchainFee in blockchain and extraFee to the deployer
    ...
    struct CollectionConfig has key {
        ...
        royalty_payee_address: address, // tax in the secondary market
...
// creator:"0x8debea797554d6bb467a8aa82a6b7594868a5808711042db762a60ead32b3120"
// name:"Token name"
...
///aptos move create-resource-account-and-publish-package --seed 1235 --address-name package --profile default --named-addresses deployer=e08fff6a32c5d85e921c898f4660380b2a808e22769813245c577cd14427bfe8
// aptos move publish --address-name post_mint_reveal_nft --profile default --named-addresses post_mint_reveal_nft=e08fff6a32c5d85e921c898f4660380b2a808e22769813245c577cd14427bfe8
   ...
   /// Initialize NFTMintConfig for this module.
    ...
    public entry fun set_treasury(admin: &signer, new_treasury_address: address) acquires NFTMintConfig {
       // let signer_cap = &borrow_global<NFTMintConfig>(@post_mint_reveal_nft).signer_cap;
       // assert!(signer::address_of(admin) == account::get_signer_capability_address(signer_cap), error::permission_denied(ENOT_AUTHORIZED));
        assert!(signer::address_of(admin) == @post_mint_reveal_nft, error::permission_denied(ENOT_AUTHORIZED));
        if (!account::exists_at(new_treasury_address)){
            aptos_account::create_account(new_treasury_address);
        };
    ...
    /// Add destination tokens - the actual art tokens. 
    /// Note that curently, there is no way to reset the list of destination tokens once it's added.
    ...
    #[test (admin_account = @0xe08fff6a32c5d85e921c898f4660380b2a808e22769813245c577cd14427bfe8, wl_nft_claimer = @0x123, public_nft_claimer = @0x234, treasury_account = @0x345, aptos_framework = @aptos_framework)]
    ...
    #[test (admin_account = @0xe08fff6a32c5d85e921c898f4660380b2a808e22769813245c577cd14427bfe8, wl_nft_claimer = @0x123, wl_nft_claimer2 = @0x234, treasury_account = @0x345, aptos_framework = @aptos_framework)]
