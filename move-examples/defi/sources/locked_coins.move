...
module defi::locked_coins {
    ...
    /// Custom locked coin.  Represents a lock of coins until some specified unlock time. Afterward, the recipient can claim the coins.
    struct Lock<phantom CoinType> has store {
        coins: Coin<CoinType>,  // Inner value:u64
