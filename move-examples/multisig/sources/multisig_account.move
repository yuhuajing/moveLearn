...
module aptos_framework::multisig_account {
  ...
  //      let (multisig_signer, multisig_signer_cap) = account::create_resource_account(owner, create_multisig_account_seed(to_bytes(&owner_nonce))); 
    ...
    public entry fun test_create_with_too_many_signatures_required_should_fail(
        ...
        setup();
        create_account(address_of(owner));
        create(owner, 2, vector[], vector[]); // create_with_owners_internal  EINVALID_SIGNATURES_REQUIRED
    }
    ...
    public entry fun test_create_with_duplicate_owners_should_fail(
        ...
        create_with_owners(
            ...
            vector[
                ...
                address_of(owner_2),
                address_of(owner_3),
                address_of(owner_2), // validate_owners EDUPLICATE_OWNER
            ],
            2,
            vector[],
            vector[]);
    ...
    public entry fun test_create_with_creator_in_additional_owners_list_should_fail(
        ...
        create_with_owners(owner_1, vector[
            ...
            address_of(owner_1), // check_after_push
            address_of(owner_2),
            address_of(owner_3),
        ], 2,
            vector[],
