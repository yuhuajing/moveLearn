...
module 0x1::basic_coin {
    ...
    #[test(account = @0x2)] // Creates a signer for the `account` argument with address `@0x1`
    #[expected_failure(abort_code = 0, location = Self)] // This test should abort
    ...
    #[test(account = @0x1)] // Creates a signer for the `account` argument with the value of the named address `named_addr`
